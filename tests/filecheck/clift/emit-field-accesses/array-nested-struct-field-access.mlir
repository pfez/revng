...
module attributes {clift.module} {
  ...
  // CHECK: [[ADDRESSOF2:%[0-9]+]] = clift.addressof [[SUBSCRIPTION1]]
  // CHECK: [[INDIRECTION2:%[0-9]+]] = clift.indirection [[ADDRESSOF2]]
  // CHECK: [[DECAY2:%[0-9]+]] = clift.decay [[INDIRECTION2]]
  ...
  // CHECK: [[SUBSCRIPTION1:%[0-9]+]] = clift.subscript [[DECAY1]], [[ARG0]]
  // CHECK: [[ADDRESSOF2:%[0-9]+]] = clift.addressof [[SUBSCRIPTION1]]
  // CHECK: [[ACCESS:%[0-9]+]] = clift.access<indirect 0> [[ADDRESSOF2]]
  // CHECK: [[ADDRESSOF3:%[0-9]+]] = clift.addressof [[ACCESS]]
